...
void hard_init(void)
{
  ...
  RCC_AHB1PeriphClockCmd(OLED_SPIx_SCK_GPIO_CLK | OLED_SPIx_MOSI_GPIO_CLK|OLED_DC_GPIO_CLK|OLED_RESET_GPIO_CLK|OLED_CS_GPIO_CLK, ENABLE);
  ...
  RCC_AHB1PeriphClockCmd(EC11_A_GPIO_CLK|EC11_B_GPIO_CLK,ENABLE);
#endif
  ...
  RCC_AHB1PeriphClockCmd(DRV8301_FAULT_GPIO_CLK|DRV8301_OCTW_GPIO_CLK,ENABLE);
  ...
  GPIO_InitStructure.GPIO_Pin = DRV8301_OCTW_PIN;
  GPIO_Init(DRV8301_OCTW_GPIO_PORT, &GPIO_InitStructure);
...
#if EC11_ENCODER_ENABLE
  SYSCFG_EXTILineConfig(EC11_A_EXTI_GPIO_PORT, EC11_A_EXTI_SOURCE);
  SYSCFG_EXTILineConfig(EC11_B_EXTI_GPIO_PORT, EC11_B_EXTI_SOURCE);

  EXTI_InitStructure.EXTI_Line = EC11_A_EXTI_LINE|EC11_B_EXTI_LINE;
  EXTI_InitStructure.EXTI_Mode = EXTI_Mode_Interrupt;
